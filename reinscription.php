...
<link rel="stylesheet" type="text/css" href="css/styleinscription.css"/>
		...
		<div class="container">						
			...
			<section>
				...
				<form method="post" action="" id="form">
					...
					<div class="row form">								
						<div class="col-md-6 colonne">							
							<div class="form-group">						
								...
								<select class="form-control formation" name="choix" >
									<option value="" name="">Sélectionnez une formation</option>
							...
							<div class="form-group">		
								...
								<select class="form-control lieu" name="choix" value="choosedateforma" >
									<option value="" name="">Sélectionnez une date</option>
							...
							<div class="form-group">		
								...
								<select class="form-control theme" name="choix" value="theme" >
									<option value="" name="">Choisissez un thème</option>
					...
					<div class="pad">					
						</br><p><input  type="checkbox"/> Si paiement par un tiers, merci de cocher cette case <button type="button" class="btn btn-xs" data-toggle="tooltip" data-placement="right" title="Uniquement en cas de paiement par une autre personne que vous">?</button></p>
		...
		<script src="js/jquery/dist/messages_fr.min.js"></script>
