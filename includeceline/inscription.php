			...
			<form method="post" action="include/dbinscription.php" id="register-form" class="well form-horizontal">
				...
				<div class="row form">								
					<div class="col-md-6 colonne">		
						...
						<div class="form-group">
							<label> Carte d'identité  <span class="asterisque">*</span> <button type="button" class="btn btn-xs resphidden" data-toggle="tooltip" data-placement="right" title="Seulement les images sont acceptées.">?</button></label>
					...
					<div class="col-md-6 colonne">
						...
						<div class="form-group">
							<label> Allergies ou régimes alimentaires <span class="asterisque">*</span> <button type="button" class="btn btn-xs resphidden" data-toggle="tooltip" data-placement="right" title="Même si vous n'avez aucunes allergies ou régimes alimentaires, merci de le signifier dans la case prévue à cette effet.">?</button></label>
