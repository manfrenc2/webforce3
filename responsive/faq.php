<?php require ('header.php'); ?>
			...
			<!-- Début du contenu principal de la page foire aux questions  -->					
	<section>
				...
				<div class="panel-group" id="accordion">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title"><!-- Question BAFA  -->	
								<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Comment se déroule le BAFA ?</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title"> <!-- Question BAFD -->	
								<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Comment se déroule le BAFD ?</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title"><!-- Question A QUOI CA SERT   -->	
								<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">A quoi ça sert ?  </a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">  <!-- Question diplôme -->	
								<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour">Comment obtenir son diplôme ? </a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">  <!-- Question âge -->	
								<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive">A partir de quel âge peut-on accéder à la formation BAFA /BAFD ? </a>
							</h4>
						</div>
						<div id="collapseFive" class="panel-collapse collapse">
							<div class="panel-body">
								<p>Il est impératif d'avoir <strong>17 ans</strong> révolu au premier jour du stage de formation Générale BAFA, mais il est possible de s'inscrire avant à la formation.
								On peut accéder à la formation BAFD à partir de <strong>21 ans</strong> révolu, il faut également être en possession du BAFA.</p> 
							</div>
						</div>
					</div>
					<div class="panel panel-default">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title"> <!-- Question argent  -->
								<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSeven">Combien ça coûte ? </a>
							</h4>
						</div>
						<div id="collapseSeven" class="panel-collapse collapse">
							<div class="panel-body">
								<p> Le tarif est fonction du stage et de sa formule en pension complète ou demie pension. Ces informations se trouvent dans <strong>le calendrier des stages</strong> présent sur la page d'accueil ou la page des différentes formations. </p>
							</div>
						</div>
					</div>
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title"> <!-- Question aide  -->
								<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseEight">Quelles sont les aides financières ?
								</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title"> <!-- Question paiement après site  -->
								<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseNine">Que se passe t-il lorsque j'ai payé sur le site ?  </a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title"> <!-- Question internat ou demi pension   -->
								<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTen">Internat ou demi pension ? </a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title"> <!-- Question date formation  -->
								<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseEleven">Où trouver les dates de formation ?</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title"> <!-- Question stage pratique-->
								<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwelve">Où et comment trouver un stage pratique ?</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title"><!-- Question ressources pédagogiques -->
								<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThirteen">Comment avoir accès aux ressources pédagogiques ?</a>
							</h4>
						</div>
